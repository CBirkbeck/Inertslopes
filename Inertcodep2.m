...
/*To run the code, whan you want do is run the code UpMatrix, this takes as input the precision at which you want to work with, i.e. what precision the matric entries will have.
